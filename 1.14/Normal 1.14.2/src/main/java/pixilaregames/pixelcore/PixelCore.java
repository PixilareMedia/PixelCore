...
{
	//Basic Things Reguarding The Mod
	...
	//Registering For Everyrthing Else
	public PixelCore()
	{
		instance = this;
	...
	//Setup For Ore Generation, Entities, Ect.
	...
	public static class RegistryEvents
	{
		...
		//Determining If Mods That Are Dependencies Or Dependants ARe Loaded
		@SubscribeEvent
