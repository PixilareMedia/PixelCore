...
public class PixelCore
{
	...
	public PixelCore()
	{
		...
		ModLoadingContext.get().registerConfig(net.minecraftforge.fml.config.ModConfig.Type.COMMON, pixilaregames.pixelcore.Config.PixelCoreConfig.spec, "PixelCore.toml");
