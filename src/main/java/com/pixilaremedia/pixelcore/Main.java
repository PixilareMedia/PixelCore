...
import com.pixilaremedia.pixelcore.client.render.ScreenRendering;
...
public class Main
{
    ...
    public void commonSetup(FMLCommonSetupEvent event)
    {
        ...
        References.LOGGER.info(Ref.LOG_NAME + " Finished Common Setup");
    }
    ...
    public void clientSetup(FMLClientSetupEvent event)
    {
        ...
        References.LOGGER.info(Ref.LOG_NAME + " Finished Client Setup");
    }

    public void onServerAboutToStartEvent(FMLServerAboutToStartEvent event)
    {
        //Register Villager Houses.
        ...
        References.LOGGER.info(Ref.LOG_NAME + " Finished Server About To Start");
    }

    public void onServerStarting(FMLServerStartingEvent event)
    {
        //Random bullshit because I felt like it.
        int countCurrency = event.getServer().overworld().getRecipeManager().byType(RecipeTypeInit.CURRENCY_CONVERSION).size();
        int countEtching = event.getServer().overworld().getRecipeManager().byType(RecipeTypeInit.ETCHING).size();
        References.LOGGER.info(Ref.LOG_NAME + " " + countCurrency + " currency conversion recipes loaded.");
        References.LOGGER.info(Ref.LOG_NAME + " " + countEtching + " etching recipes loaded.");
    }
    ...
    {
        //Checking for other mods that we care about.
        ...
        References.LOGGER.info(Ref.LOG_NAME + " Finished Post Setup");
    }
}
